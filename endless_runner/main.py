...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        for i in range(10):
            running_sprite = pygame.image.load(f'html/python/Jeu/endless_runner/images/running/run{i}.png').convert_alpha()
        ...
        for i in range(10):
            jumping_sprite = pygame.image.load(f'html/python/Jeu/endless_runner/images/jumping/jump{i}.png').convert_alpha()
...
class Obstacle(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        for image_name in ['rock1', 'rock2', 'rock3', 'spikes']:
            image = pygame.image.load(f'html/python/Jeu/endless_runner/images/obstacles/{image_name}.png').convert_alpha()
...
sky = pygame.image.load('html/python/Jeu/endless_runner/images/bg/sky.png').convert_alpha()
num_bg_tiles = math.ceil(game_width / sky.get_width()) + 1

# set the images for the parallax background
bgs = []
bgs.append(pygame.image.load('html/python/Jeu/endless_runner/images/bg/mountains.png').convert_alpha())
bgs.append(pygame.image.load('html/python/Jeu/endless_runner/images/bg/trees.png').convert_alpha())
bgs.append(pygame.image.load('html/python/Jeu/endless_runner/images/bg/bushes.png').convert_alpha())
...
for i in range(8):
    heart_sprite = pygame.image.load(f'html/python/Jeu/endless_runner/images/heart/heart{i}.png').convert_alpha()
...
while not quit:
    ...
    while gameover and not quit:
        ...
        font = pygame.font.Font(pygame.font.get_default_font(), 16)
        text = font.render('Game over. Play again? (Enter Y to play again or N to exit)', True, black)
        text_rect = text.get_rect()
